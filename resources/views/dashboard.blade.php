<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
            {{ __('Dashboard') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Welcome Card -->
            <div class="bg-white/90 backdrop-blur-sm overflow-hidden shadow-2xl sm:rounded-2xl border border-white/20 mb-8">
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <a href="{{ route('cars.index') }}" class="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl hover:shadow-lg transition-all duration-200 group">
                        ...
                        <a href="{{ route('cars.create') }}" class="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl hover:shadow-lg transition-all duration-200 group">
                            <div class="flex items-center gap-3 mb-3">
                        ...
                        <a href="/" class="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl hover:shadow-lg transition-all duration-200 group">
                            <div class="flex items-center gap-3 mb-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white/90 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-white/20 p-6">
